...
|---|---|---|---|
| [BBox auto propagation](plugins/bbox_auto_propagation_nano_tracker/)|Auto bbox propagation using nano tracker|Lightly| `pip install -e plugins/bbox_auto_propagation_nano_tracker`|
